...
- (void)commonInitialization {
    ...
    _badgeBackgroundColor = [UIColor blackColor];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (![_title length]) {
        ...
        if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_1) {
            titleSize = [_title boundingRectWithSize:CGSizeMake(frameSize.width, titleFontSize)
            ...
            titleSize = [_title sizeWithFont:titleAttributes[UITextAttributeFont]
                           constrainedToSize:CGSizeMake(frameSize.width,titleFontSize)];
